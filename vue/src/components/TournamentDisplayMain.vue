<template>
  <div class="preview">
    ...
    <h3 class="centered">Registration Type: {{this.tournament.registrationType}}</h3>
    <br />
    ...
    <h3>Register By: {{this.tournament.registrationClosedDate}}</h3>
    <h3>Start Date: {{this.tournament.startDate}}</h3>
      </div>
      </div>
  </div>
    </div>
